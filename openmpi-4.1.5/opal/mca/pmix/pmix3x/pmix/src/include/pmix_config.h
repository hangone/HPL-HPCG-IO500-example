...
#define PMIX_CONFIGURE_CLI " \'--disable-man-pages\' \'--disable-debug\' \'--with-pmix-symbol-rename=OPAL_MCA_PMIX3X_\' \'--enable-embedded-mode\' \'--disable-pmix-timing\' \'--without-tests-examples\' \'--disable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--enable-embedded-libevent\' '--with-libevent-header=\"opal/mca/event/libevent2022/libevent2022.h\"' \'--enable-embedded-hwloc\' '--with-hwloc-header=\"opal/mca/hwloc/hwloc201/hwloc201.h\"' \'--prefix=/usr/local/openmpi\' \'CFLAGS=-O3 -DNDEBUG  \' \'CPPFLAGS=-I/home/hangyi/openmpi-4.1.5 -I/home/hangyi/openmpi-4.1.5 -I/home/hangyi/openmpi-4.1.5/opal/include -I/home/hangyi/openmpi-4.1.5/opal/include -I/home/hangyi/openmpi-4.1.5/opal/mca/event/libevent2022/libevent -I/home/hangyi/openmpi-4.1.5/opal/mca/event/libevent2022/libevent/include -I/home/hangyi/openmpi-4.1.5/opal/mca/hwloc/hwloc201/hwloc/include  \' \'--cache-file=/dev/null\' \'--srcdir=.\' \'--disable-option-checking\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "2023-05-19T11:35:09"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "DESKTOP-VHIQPUO"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "hangyi"
...
#define PMIX_PACKAGE_STRING "PMIx hangyi@DESKTOP-VHIQPUO Distribution"
