...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -mcx16  -D__EXTENSIONS__' CPPFLAGS='-I/home/hangyi/openmpi-4.1.5/opal/mca/event/libevent2022/libevent -I/home/hangyi/openmpi-4.1.5/opal/mca/event/libevent2022/libevent/include -I/home/hangyi/openmpi-4.1.5/opal/mca/hwloc/hwloc201/hwloc/include   -I/usr/local/include -I/usr/local/include' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/usr/local/openmpi --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OPAL_PACKAGE_STRING "Open MPI hangyi@DESKTOP-VHIQPUO Distribution"
